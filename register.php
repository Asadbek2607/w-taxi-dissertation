  ...
  <div class="d-flex  justify-content-center align-items-center col-lg-7 bg-gradient-light text-dark">
    <div class="card card-outline card-purple w-75">
      <div class="card-header text-center">
          <a href="./" class="text-decoration-none text-dark"><b><i class="fab fa-weebly" style="color: #F7B731;"></i><span style="color: #F7B731">-Taxi</span>   <br> Create an Account - Client</b></a>
      </div>
      <div class="card-body">
        <form id="register-frm" action="" method="post">
          ...
          <div class="row">
              ...
              <a href="<?php echo base_url.'login.php' ?>" style="text-decoration:none; color: #F7B731;">Already have an Account</a>
              </div>
          </div>
        </form>
        <!-- /.social-auth-links -->
