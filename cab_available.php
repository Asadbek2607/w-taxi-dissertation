            ...
            <hr>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-xl-3" id="cab_list">
                    ...
                    while($row = $cabs->fetch_assoc()):
                        ?>
                        <a class="col-sm-6 col-md-4 col-xl-4 item text-decoration-none text-dark book_cab" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>" data-bodyno="<?php echo $row['body_no'] ?>">
                            <div class="callout callout-primary border-success rounded-0 d-flex flex-column" style="height: 20vw;">
                                ...
                                <div style="height: 12vw;">
                                    <img style="width: 100%; height: 100%; object-fit: contain;" src="<?php echo $row['image_path'] ?>" alt="car img">
                                </div>
                            </div>
                        </a>
                    <?php endwhile; ?>
